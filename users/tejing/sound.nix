...

{
  ...
  xsession.windowManager.i3.config.startup = [{ command = "${pkgs.rxvt-unicode}/bin/urxvtc -name ncmpc -e ${my.templateScript pkgs "mylaunch" scripts/mylaunch} app ncmpc ${pkgs.ncmpc}/bin/ncmpc"; always = false; notification = false; }];
